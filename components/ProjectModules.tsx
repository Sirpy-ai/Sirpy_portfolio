      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {PROJECTS.map((project) => {
          ...
          return (
            ...
            >
              {isHighlighted && (
                <div className="absolute -inset-4 border border-safety-orange/40 animate-pulse pointer-events-none">
              ...
              <div className="bg-cad-gray/10 blueprint-grid-fine border border-cad-gray/30 p-1 relative">
